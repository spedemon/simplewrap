...
def load_c_library(library_name,library_path): 
    ...
    if not library_found: 
        ...
        try:
            ...
            raise InstallationError("The library %s was found but could not be loaded. It is likely due to a linking error, missing libraries. "%library_name) 
        else: 
            return L
...
def list_functions(c_library): 
    ...
    if c_library.swrap_list_functions(list): 
        raise LibraryError("The library does not support simplewrap. ")
